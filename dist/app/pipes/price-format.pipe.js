    ...
    return {
        ...
        execute: function() {
            PriceFormatPipe = (function () {
                function PriceFormatPipe(globalFunctions) {
                    this.globalFunctions = globalFunctions;
                }
                PriceFormatPipe.prototype.transform = function (value) {
                ...
                PriceFormatPipe = __decorate([
                    ...
                    __metadata('design:paramtypes', [global_functions_1.GlobalFunctions])
                ], PriceFormatPipe);
