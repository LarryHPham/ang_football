System.register(['@angular/core', "@angular/router-deprecated"], function(exports_1, context_1) {
    ...
    return {
        ...
        execute: function() {
            ArticleSubComponent = (function () {
                function ArticleSubComponent() {
                }
                ArticleSubComponent = __decorate([
                    core_1.Component({
                ...
                return ArticleSubComponent;
            }());
            exports_1("ArticleSubComponent", ArticleSubComponent);
        }
    }
});
