System.register(['@angular/core', '@angular/router-deprecated'], function(exports_1, context_1) {
    ...
    return {
        ...
        execute: function() {
            ComplexInnerHtml = (function () {
                function ComplexInnerHtml() {
                }
                __decorate([
                    core_1.Input(), 
                    __metadata('design:type', Array)
                ], ComplexInnerHtml.prototype, "textItems", void 0);
                ComplexInnerHtml = __decorate([
                    core_1.Component({
                ...
                return ComplexInnerHtml;
            }());
            exports_1("ComplexInnerHtml", ComplexInnerHtml);
        }
    }
});
