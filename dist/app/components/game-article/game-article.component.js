System.register(['@angular/core', '@angular/router-deprecated'], function(exports_1, context_1) {
    ...
    return {
        ...
        execute: function() {
            GameArticle = (function () {
                function GameArticle() {
                }
                GameArticle.prototype.ngOnInit = function () {
                };
                __decorate([
                    core_1.Input(), 
                    __metadata('design:type', Object)
                ], GameArticle.prototype, "gameArticle", void 0);
                GameArticle = __decorate([
                    core_1.Component({
            ...
            exports_1("GameArticle", GameArticle);
        }
    }
});
