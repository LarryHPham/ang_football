System.register(['@angular/core', '@angular/router-deprecated'], function(exports_1, context_1) {
    ...
    return {
        ...
        execute: function() {
            PartnerHomePage = (function () {
                function PartnerHomePage() {
                }
                PartnerHomePage.prototype.getPartners = function () {
                    var partners = [
                        {
                            name: 'Arkansas',
                            websites: [
                ...
                PartnerHomePage.prototype.ngOnInit = function () {
                    this.partners = this.getPartners();
                };
                PartnerHomePage = __decorate([
                    core_1.Component({
            ...
            exports_1("PartnerHomePage", PartnerHomePage);
        }
    }
});
