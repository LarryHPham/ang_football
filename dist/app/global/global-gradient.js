    ...
    return {
        ...
        execute: function() {
            Color = (function () {
                ...
                Color.parseColor = function (hexValue) {
                    if (hexValue != null) {
                ...
                Color.decimalToHex = function (d, padding) {
                ...
                Color.prototype.toRgbFormat = function (alpha) {
                    if (alpha != null) {
                ...
                Color.lightOrDark = function (colorStr) {
                    var epsilon = 255;
            ...
            Gradient = (function () {
                ...
                Gradient.getGradientStyles = function (colorStrings, alpha) {
                    var colors = [];
                 ...
                 *
                 */
                Gradient.areColorsClose = function (colorStr1, colorStr2) {
                    var epsilon = 255;
                 ...
                 */
                Gradient.getColorPair = function (colorSetOne, colorSetTwo) {
