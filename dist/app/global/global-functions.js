    ...
    return {
        ...
        execute: function() {
            GlobalFunctions = (function () {
                 ...
                 * @returns: string
                 */
                GlobalFunctions.Suffix = function (i) {
                    var a = i % 10, b = i % 100;
                    if (a == 1 && b != 11) {
                        return "st";
                    }
                 ...
                 * @returns {string}
                 */
                GlobalFunctions.prototype.toTitleCase = function (str) {
                ...
                ;
                GlobalFunctions.toTitleCase = function (str) {
                    if (str === undefined || str === null) {
                        return str;
                    }
                    return str.replace(/\w\S*/g, function (txt) {
                 ...
                 */
                GlobalFunctions.prototype.formatPhoneNumber = function (val) {
                 ...
                 * @returns {string}
                 */
                GlobalFunctions.commaSeparateNumber = function (value, def) {
                 ...
                 * @returns {string}
                 */
                GlobalFunctions.prototype.formatPriceNumber = function (value, def) {
                 ...
                 * @returns {string}
                 */
                GlobalFunctions.fullstate = function (state) {
                    ...
                    var displayState = stateName[upperState];
                 ...
                 * @returns {string}
                 */
                GlobalFunctions.stateToAP = function (state) {
                    if (state === undefined || state === null) {
                        return state;
                    }
                    var stateAP = {
                    ...
                    var upperState = state.toUpperCase();
                    var displayState = stateAP[upperState];
                    return displayState !== undefined ? displayState : state;
                };
                ;
                /**
                 ...
                 * @returns {string}
                 */
                GlobalFunctions.prototype.camelCaseToRegularCase = function (str) {
                    if (str === undefined || str === null) {
                        return str;
                    }
                    return str
                 ...
                 * @returns {string}
                 */
                GlobalFunctions.prototype.kababCaseToCamelCase = function (str) {
                    if (str === undefined || str === null) {
                        return str;
                    }
                    str = str.replace(/-/g, ' ');
                 ...
                 * @returns {string}
                 */
                GlobalFunctions.prototype.camelCaseToKababCase = function (str) {
                    if (str === undefined || str === null) {
                        return str;
                    }
                    str = str
                 ...
                 * @returns {string}
                 */
                GlobalFunctions.toLowerKebab = function (str) {
                    str = str.toLowerCase()
                        .replace(/\s+/g, '-')
                        .replace(/[\.,']/g, '');
                    return str;
                 ...
                 */
                GlobalFunctions.formatUpdatedDate = function (jsDate, includeTimestamp, timezone) {
                 ...
                 * @returns {string} - formatted string
                 */
                GlobalFunctions.formatDateWithAPMonth = function (jsDate, beforeMonthFormat, afterMonthFormat) {
                    var date = moment(jsDate);
                 ...
                 * @returns MMMM d, YYYY
                 */
                GlobalFunctions.formatLongDate = function (dateStr) {
                    if (!dateStr) {
                        return "N/A";
                    }
                 ...
                 * @returns
                 */
                GlobalFunctions.formatAPMonth = function (month) {
                    switch (month) {
                        case 0: return "Jan.";
                        case 1: return "Feb.";
                        case 2: return "March";
                 ...
                 * @returns
                 */
                GlobalFunctions.formatNumber = function (num) {
                    switch (num) {
                        case 0: return "zero";
                        case 1: return "one";
                        case 2: return "two";
                ...
                GlobalFunctions.setupAlphabeticalNavigation = function (pageType) {
                    var navigationArray = [];
                 ...
                 */
                GlobalFunctions.parseToRoute = function (stringRoute) {
                    if (stringRoute == null) {
                        return ["Error-page"];
                    }
                    var stringRouteArr = stringRoute.split("|");
                    var generatedUrl = stringRouteArr.map(function (item) {
                        try {
                 ...
                 */
                GlobalFunctions.nFormatter = function (num) {
                    if (num >= 1000000000) {
                ...
                */
                GlobalFunctions.getHostName = function (url) {
                 ...
                 */
                GlobalFunctions.convertToPossessive = function (name) {
            ...
            exports_1("GlobalFunctions", GlobalFunctions);
        }
    }
});
