    ...
    if ( this.pageParams.teamId ) {
      ...
      .subscribe(
          data => {
            ...
            var teamRoute = TDLGlobalFunctions.formatTeamRoute(data.teamName, this.pageParams.teamId.toString());
          },
          err => {
            this.isError= true;
      ...
      this._profileService.getLeagueProfile()
        .subscribe(
          data => {
            ...
            var teamRoute = TDLGlobalFunctions.formatTeamRoute(this.profileName, null);
          },
          err => {
            this.isError= true;
              console.error('Error: transactionsData Profile Header API: ', err);
